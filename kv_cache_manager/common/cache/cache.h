...
#include "kv_cache_manager/common/cache/compression_type.h"
#include "kv_cache_manager/common/cache/data_structure.h"
...
constexpr uint32_t kNumCacheEntryRoles = static_cast<uint32_t>(CacheEntryRole::kMisc) + 1;
...
const CacheMetadataChargePolicy kDefaultCacheMetadataChargePolicy = kFullChargeCacheMetadata;
...
// DEPRECATED wrapper function
inline std::shared_ptr<Cache> NewLRUCache(const LRUCacheOptions &cache_opts) { return cache_opts.MakeSharedCache(); }
...
struct CompressedSecondaryCacheOptions : LRUCacheOptions {
    ...
    CompressedSecondaryCacheOptions(
        ...
        const CacheEntryRoleSet &_do_not_compress_roles = {CacheEntryRole::kFilterBlock})
...
// DEPRECATED wrapper function
inline std::shared_ptr<SecondaryCache>
NewCompressedSecondaryCache(size_t capacity,
                            int num_shard_bits = -1,
                            bool strict_capacity_limit = false,
                            double high_pri_pool_ratio = 0.5,
                            double low_pri_pool_ratio = 0.0,
                            ...
                            bool enable_custom_split_merge = false,
                            const CacheEntryRoleSet &_do_not_compress_roles = {CacheEntryRole::kFilterBlock}) {
    return CompressedSecondaryCacheOptions(capacity,
                                           num_shard_bits,
                                           strict_capacity_limit,
                                           high_pri_pool_ratio,
                                           low_pri_pool_ratio,
...
// DEPRECATED wrapper function
inline std::shared_ptr<SecondaryCache> NewCompressedSecondaryCache(const CompressedSecondaryCacheOptions &opts) {
...
struct HyperClockCacheOptions : public ShardedCacheOptions {
    ...
    HyperClockCacheOptions(size_t _capacity,
                           size_t _estimated_entry_charge,
                           int _num_shard_bits = -1,
...
//    again
ErrorCode UpdateTieredCache(const std::shared_ptr<Cache> &cache,
