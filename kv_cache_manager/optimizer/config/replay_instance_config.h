...
class OptimizerReplayInstanceConfig : public Jsonizable {
public:
    OptimizerReplayInstanceConfig() = default;
    ~OptimizerReplayInstanceConfig() override = default;
...
public:
    ...
    [[nodiscard]] int64_t bytes_per_block() const;
...
private:
    ...
    int64_t bytes_per_token_ = 0; // bytes_per_block = block_size * bytes_per_token
