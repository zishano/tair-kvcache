...
instance_group module:
    ...
    create new instance_group:
        ...
        python3 -m kvcm_ops create_instance_group -H http://localhost:56040 -n test_group -s nfs_01 --extra_info '{"metadata_backend_mode":2}'
    ...
    update existed instance_group(version of instance_group will plus one automatically):
        ...
        python3 -m kvcm_ops update_instance_group -n test_group --extra_info '{"metadata_backend_mode":2}'
'''