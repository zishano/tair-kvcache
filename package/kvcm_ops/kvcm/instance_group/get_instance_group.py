...
'''
curl -g -vvv -X POST http://localhost:56040/api/getInstanceGroup \
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        prog="python3 script.kvcm.instance_group.get_instance_group",
        description="kvcm: get_instance_group.",
