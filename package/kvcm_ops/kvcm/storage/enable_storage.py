...
'''
curl -g -vvv -X POST http://localhost:56040/api/enableStorage \
...
def main():
    args = parse_simple_args("enable_storage")
    data = {
        "trace_id": args.trace_id,
        "storage_unique_name": args.unique_name
    }
    result = http_post(args.host, "/api/enableStorage", data, args.verbose)
